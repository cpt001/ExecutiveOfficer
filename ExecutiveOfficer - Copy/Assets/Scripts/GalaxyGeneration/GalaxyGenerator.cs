...
public class GalaxyGenerator : MonoBehaviour
{
    ...
    void TriggerGeneration()
    {
        ...
        for (int i = 0; i < genControl.numNodes; i++) //Num you want
        {
            ...
            var newSystem = Instantiate(localSystemGenerator, new Vector3(x, 0, z), Quaternion.identity, centralTransform);
            newSystem.transform.parent = gameObject.transform;
            newSystem.name = "Sector " + (i + 1);
