    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float node_133 = pow((abs((frac((o.uv0+node_7195.g*float2(0.25,0)).r)-0.5))*2.0),_BulgeShape_var); // Panning gradient
                float node_1924 = node_133;
                float _BulgeScale_var = UNITY_ACCESS_INSTANCED_PROP( Props, _BulgeScale );
                v.vertex.xyz += (node_1924*_BulgeScale_var*v.normal);
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float4 node_7195 = _Time;
                float _BulgeShape_var = UNITY_ACCESS_INSTANCED_PROP( Props, _BulgeShape );
                float node_133 = pow((abs((frac((i.uv0+node_7195.g*float2(0.25,0)).r)-0.5))*2.0),_BulgeShape_var); // Panning gradient
...
////// Emissive:
                ...
                float node_1924 = node_133;
                float3 emissive = (_GlowColor_var.rgb*_GlowIntensity_var*node_1924);
/// Final Color:
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.tangentDir = normalize( mul( unity_ObjectToWorld, float4( v.tangent.xyz, 0.0 ) ).xyz );
                o.bitangentDir = normalize(cross(o.normalDir, o.tangentDir) * v.tangent.w);
                float4 node_1513 = _Time;
                float _BulgeShape_var = UNITY_ACCESS_INSTANCED_PROP( Props, _BulgeShape );
                float node_133 = pow((abs((frac((o.uv0+node_1513.g*float2(0.25,0)).r)-0.5))*2.0),_BulgeShape_var); // Panning gradient
                float node_1924 = node_133;
                float _BulgeScale_var = UNITY_ACCESS_INSTANCED_PROP( Props, _BulgeScale );
                v.vertex.xyz += (node_1924*_BulgeScale_var*v.normal);
                o.posWorld = mul(unity_ObjectToWorld, v.vertex);
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float4 node_1513 = _Time;
                float _BulgeShape_var = UNITY_ACCESS_INSTANCED_PROP( Props, _BulgeShape );
                float node_133 = pow((abs((frac((i.uv0+node_1513.g*float2(0.25,0)).r)-0.5))*2.0),_BulgeShape_var); // Panning gradient
                float3 normalLocal = normalize(lerp(_Normals_var.rgb,float3(0,0,1),node_133));
                float3 normalDirection = normalize(mul( normalLocal, tangentTransform )); // Perturbed normals
...
/// Final Color:
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.uv2 = v.texcoord2;
                o.normalDir = UnityObjectToWorldNormal(v.normal);
                float4 node_5849 = _Time;
                float _BulgeShape_var = UNITY_ACCESS_INSTANCED_PROP( Props, _BulgeShape );
                float node_133 = pow((abs((frac((o.uv0+node_5849.g*float2(0.25,0)).r)-0.5))*2.0),_BulgeShape_var); // Panning gradient
                float node_1924 = node_133;
                float _BulgeScale_var = UNITY_ACCESS_INSTANCED_PROP( Props, _BulgeScale );
                v.vertex.xyz += (node_1924*_BulgeScale_var*v.normal);
                o.posWorld = mul(unity_ObjectToWorld, v.vertex);
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.uv2 = v.texcoord2;
                o.normalDir = UnityObjectToWorldNormal(v.normal);
                float4 node_1983 = _Time;
                float _BulgeShape_var = UNITY_ACCESS_INSTANCED_PROP( Props, _BulgeShape );
                float node_133 = pow((abs((frac((o.uv0+node_1983.g*float2(0.25,0)).r)-0.5))*2.0),_BulgeShape_var); // Panning gradient
                float node_1924 = node_133;
                float _BulgeScale_var = UNITY_ACCESS_INSTANCED_PROP( Props, _BulgeScale );
                v.vertex.xyz += (node_1924*_BulgeScale_var*v.normal);
                o.posWorld = mul(unity_ObjectToWorld, v.vertex);
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 node_1983 = _Time;
                float _BulgeShape_var = UNITY_ACCESS_INSTANCED_PROP( Props, _BulgeShape );
                float node_133 = pow((abs((frac((i.uv0+node_1983.g*float2(0.25,0)).r)-0.5))*2.0),_BulgeShape_var); // Panning gradient
                float node_1924 = node_133;
                o.Emission = (_GlowColor_var.rgb*_GlowIntensity_var*node_1924);
