...
public class PlayerShipController : ShipController {
    ...
    private void SelectTurretGroup(int turretGroup) {
        if (turretGroup < 0 || turretGroup >= turretGroups.Count) {
            Debug.LogError("Turret group does not exist!");
            return;
        }
        selectedTurretGroupIndex = turretGroup;
        if (isTargeting) {
            UnhighlightModules();
            Events.instance.Raise(new ChangeGameCameraEvent(targetingCameras[selectedTurretGroupIndex], false));
        }
    ...
    public void OnTurretGroup1Select() {
        SelectTurretGroup(0);
    }

    public void OnTurretGroup2Select() {
        SelectTurretGroup(1);
    }

    public void OnTurretGroup3Select() {
        SelectTurretGroup(2);
    }

    public void OnTurretGroup4Select() {
        SelectTurretGroup(3);
    }

    public void OnTurretGroup5Select() {
        SelectTurretGroup(4);
    }

    public void OnTurretGroup6Select() {
        SelectTurretGroup(5);
    }

    public void OnTurretGroup7Select() {
        SelectTurretGroup(6);
    }

    public void OnTurretGroup8Select() {
        SelectTurretGroup(7);
    }

    public void OnTurretGroup9Select() {
        SelectTurretGroup(8);
    }

    public void OnTurretGroup10Select() {
        SelectTurretGroup(9);
    }
